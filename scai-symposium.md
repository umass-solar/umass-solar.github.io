            ...
            <details class="scai-session-details">
              ...
              <div class="scai-session-details-panel">
                ...
                <div class="scai-session-person">
                  ...
                  <p class="scai-session-description">The exponential growth of cloud computing has been a defining trend of our time, fueled by rapidly growing demands from online and data-intensive workloads. Despite the end of Denard scaling, the cloud&rsquo;s energy demand grew more slowly than expected over the past decade due to the aggressive implementation of energy-efficiency optimizations. However, the rise of AI workloads, which are often more resource-intensive than traditional cloud workloads, has led to rapid growth in data centers with power-hungry accelerators such as GPUs and TPUs, leading to a resurgence in the cloud&rsquo;s energy consumption and a strain on our electric grids.</p>
